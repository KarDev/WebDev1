    ...
    <div>
        ...
        <div class="shadow border w-64 mr-10 z-30 h-[190px]">
            ...
            <div class="p-5 flex justify-between relative cursor-pointer border-b">
                ...
                <div v-if="modal.location" class="absolute border shadow left-56 p-5 top-1 -m-1 bg-white asdf">
            ...
            <div class="p-5 flex justify-between relative cursor-pointer border-b">
                ...
                <div class="asdf absolute border shadow left-56 p-5 top-1 -m-1 w-[600px] flex justify-between flex-wrap bg-white" v-if="modal.make">
...
const onChangePrice = () => { 
    ...
    // console.log(priceRange.value.min + " - " + priceRange.value.max)
